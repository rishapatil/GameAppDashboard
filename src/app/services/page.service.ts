...
export class PageService {
    ...
    getPage(slug) {
        ...
        //     .map(res => res.json());
        return this.http.get('http://localhost:4000/pages/' + slug);
    }

    postAddPage(value) {
        // return this.http.post('http://localhost:3000/pages/add-page', value)
        //     .map(res => res.json());
        return this.http.post('http://localhost:4000/pages/add-page', value);
    }

    getEditPage(id) {
        // return this.http.get('http://localhost:3000/pages/edit-page/' + id)
        //     .map(res => res.json());
        return this.http.get('http://localhost:4000/pages/edit-page/' + id);
    }

    postEditPage(value) {
        // return this.http.post('http://localhost:3000/pages/edit-page/'+value.id, value)
        //     .map(res => res.json());
        return this.http.post('http://localhost:4000/pages/edit-page/'+value.id, value);
    }

    deletePage(id) {
        // return this.http.get('http://localhost:3000/pages/delete-page/' + id)
        //     .map(res => res.json());
        return this.http.get('http://localhost:4000/pages/delete-page/' + id);
    }
